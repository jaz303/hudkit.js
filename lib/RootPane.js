        ...
        'methods', {
            ...
            _layout: function() {
                ...
                if (this._toolbar && this._toolbarVisible) {
                    ...
                    this._toolbar.setBounds(left + theme.TOOLBAR_MARGIN_LEFT,
                                            top + theme.TOOLBAR_MARGIN_TOP,
                                            width - (theme.TOOLBAR_MARGIN_LEFT + theme.TOOLBAR_MARGIN_RIGHT),
                                            theme.TOOLBAR_HEIGHT);
                    
                    var delta = theme.TOOLBAR_HEIGHT + theme.TOOLBAR_MARGIN_BOTTOM + theme.TOOLBAR_MARGIN_TOP;
                    rootTop += delta;
                    rootHeight -= delta;
